              ...
              <table id="pegawai" class="table table-bordered table-hover">
                ...
                <td><?php echo $no=$no+1;?></td>
                  ...
                  <td>
                    ...
                    <a href="index.php?page=ubah_pegawai&id=<?=$row['nomor'];?>" class="btn btn-success" role="button" title="Ubah Data"><i class="glyphicon glyphicon-edit"></i></a>
                    ...
                    <a href="pages/pegawai/cetak.php?id=<?=$row['nomor'];?>"button class="btn btn-primary" name="cmdPrint" id="cmdPrint" type="button">Cetak PDF</button>  
                    <a href="pages/pegawai/laporan.php?id=<?=$row['nomor'];?>"button class="btn btn-primary" name="cmdPrint" id="cmdPrint" type="button">Cetak ST</button>  
                </tr>
